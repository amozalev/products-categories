...
class Test(unittest.TestCase):
    ...
    def test_fail_put_category_without_necessary_argument(self):
        resp = self.app.put('/api/v1/categories/000000000000000000000000', json={'normal_name': 'Test PUT Item1'})
        self.assertEqual(resp.status_code, 400)
    ...
    def test_fail_post_category_without_name(self):
        resp = self.app.post('/api/v1/categories/', json={'normal_name': 'Test POST Item',
                                                          'parent': None})
        self.assertEqual(resp.status_code, 400)
